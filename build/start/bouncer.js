...
exports.policies = Bouncer_1.default.registerPolicies({
    LessonPolicy: () => Promise.resolve().then(() => __importStar(global[Symbol.for('ioc.use')]('App/Policies/LessonPolicy'))),
    RolePolicy: () => Promise.resolve().then(() => __importStar(global[Symbol.for('ioc.use')]('App/Policies/RolePolicy'))),
}).policies;
